    ...
    return (
        <div className='navbar'>
            ...
            <ul ref={menuRef} className="nav-menu">
                ...
                <li><AnchorLink className='anchor-link' offset={50} href='#testimonials'><p onClick={() =>setMenu("testimonials")}>Testimonials</p></AnchorLink>{menu==="testimonials"?<img src={underline} alt= ''/>:<></>}</li>
